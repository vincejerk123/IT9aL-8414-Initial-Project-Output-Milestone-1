<x-guest-layout>
    <div class="mb-6 text-center">
        ...
        <p class="text-gray-600 mt-2">Join Kalyeng Trabaho today</p>
    </div>
        ...
        <div>
            ...
            <div class="relative">
                ...
                <input 
                    ...
                    class="w-full pl-10 pr-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 @error('name') border-red-500 @enderror"
                >
            </div>
            @error('name')
        ...
        <div>
            ...
            <div class="relative">
                ...
                <select 
                    name="role" 
                    id="role"
                    class="w-full pl-10 pr-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 appearance-none bg-white"
                >
                    <option value="user">Job Seeker</option>
                    <option value="admin">Admin (Company Representative)</option>
                </select>
            ...
            <p class="mt-1 text-xs text-gray-500">Choose "Job Seeker" to browse jobs or "Admin" to post job listings</p>
        </div>
